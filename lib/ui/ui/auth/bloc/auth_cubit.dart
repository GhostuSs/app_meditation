...
class AuthCubit extends Cubit<AuthState> {
  ...
  void navigateToReason({required BuildContext context,required String name,required String phone,required String mail}) {
    Hive.box<UserData>('user').put('user',UserData(name: name,phone: phone,mail: mail));
